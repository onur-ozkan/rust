...
complete -c x.py -n "__fish_use_subcommand" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from build" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from check" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from clippy" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from fix" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from fmt" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from doc" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from test" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from bench" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from clean" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from dist" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from install" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from run" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from setup" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
...
complete -c x.py -n "__fish_seen_subcommand_from suggest" -l dump-bootstrap-behaviour -d 'Indicates whether to dump the work done from bootstrap'
